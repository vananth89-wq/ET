-- =============================================================================
-- Migration 234: update_hire_field — add picklist / select field support
--
-- Extends the CASE statement from migration 232 to handle fields that are
-- now editable via the section edit form: picklist UUID fields and identity
-- record country/id_type/record_type.
-- =============================================================================
...
COMMENT ON FUNCTION update_hire_field(uuid, text, text) IS
  ...
  'Now handles picklist UUID fields: designation, work_country, work_location, '
  'marital_status, identity country/id_type/record_type.';
