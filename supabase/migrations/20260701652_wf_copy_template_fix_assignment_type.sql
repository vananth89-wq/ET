-- Migration 652 — wf_copy_template: add assignment_type = 'GLOBAL' to INSERT
-- Bug: workflow_assignments.assignment_type is NOT NULL; INSERT omitted it → error.
...
COMMENT ON FUNCTION wf_copy_template IS 'Mig 652: fix assignment_type = GLOBAL in workflow_assignments INSERT.';
