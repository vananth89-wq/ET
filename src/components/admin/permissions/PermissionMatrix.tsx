...
const ADMIN_GROUPS: MatrixGroup[] = [
  { groupLabel: 'Time Management', rows: [
    { code: 'time_work_schedules',    label: 'Work schedules',     availableActions: ['view','create','edit','delete'],
      rowHint: 'Define weekly work schedule templates — days of week and planned hours per day' },
    { code: 'time_holiday_calendars', label: 'Holiday calendars',  availableActions: ['view','create','edit','delete'],
      rowHint: 'Create and manage holiday calendars by country or region' },
    { code: 'time_holidays',          label: 'Holidays',           availableActions: ['view','create','edit','delete'],
      rowHint: 'Add and remove public holidays within a holiday calendar' },
    { code: 'time_types',             label: 'Time types',         availableActions: ['view','create','edit','delete'],
