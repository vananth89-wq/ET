/**
 * ExpenseReport — the Expense line-item report.
 *
 * Extracted verbatim from AdminReports.tsx so the catalog can lazy-import it
 * from the registry without a circular dependency. Behaviour is unchanged.
 *
 * NOTE: target population is filtered client-side here, which is a UX filter
 * on top of RLS, not a security boundary. New reports should scope in the
 * database instead — see mig 740 for why the client cannot compute scope.
 */
